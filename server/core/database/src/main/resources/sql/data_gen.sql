...
VALUES ('John', 'Doe', 'john.doe@example.com', '123456789'),
       ...
       ('Christopher', 'Martinez', 'christopher.martinez@example.com', '555111222'),
       ('Jessica', 'Anderson', 'jessica.anderson@example.com', '555333444'),
       ('Daniel', 'Taylor', 'daniel.taylor@example.com', '555555666'),
       ('Ashley', 'Thomas', 'ashley.thomas@example.com', '555777888'),
       ('Matthew', 'Jackson', 'matthew.jackson@example.com', '555999000'),
       ('Amanda', 'White', 'amanda.white@example.com', '555123789'),
       ('Anthony', 'Harris', 'anthony.harris@example.com', '555456123'),
       ('Stephanie', 'Martin', 'stephanie.martin@example.com', '555789456'),
       ('Kevin', 'Thompson', 'kevin.thompson@example.com', '555147258'),
       ('Michelle', 'Garcia', 'michelle.garcia@example.com', '555369852');

-- Create room bookings with controlled occupancy rates
DO
$$
    DECLARE
        base_start_date  DATE := CURRENT_DATE - INTERVAL '14 days';
